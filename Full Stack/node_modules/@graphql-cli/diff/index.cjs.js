...
const diffCommand = require('@graphql-inspector/diff-command');
        ...
        handler(args) {
            return tslib.__awaiter(this, void 0, void 0, function* () {
                ...
                const config = yield api.useConfig({
                    ...
                    extensions: [graphqlCliCommon.createInspectorExtension('diff')],
                });
                const { loadSchema } = api.useLoaders({ loaders: graphqlCliCommon.loaders });
                let baseSchema;
                let newSchema;
                if (!args.target) {
                    // Case 1: <no args>
