...
function validate(schema, sources, options) {
    ...
    documents
        ...
        const deprecated = config.strictDeprecated
            ? findDeprecatedUsages(transformedSchema, graphql.parse(doc.source.body))
            : [];
    ...
    const visitor = (source) => ({
        Field(node) {
            ...
            if (parent &&
                ...
                const locations = coverage.types[parent.name].children[fieldDef.name].locations[source.name];
